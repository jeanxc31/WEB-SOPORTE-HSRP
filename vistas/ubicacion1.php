...
<div class="box-header with-border">
  <h1 class="box-title">Área/Servicio <button class="btn btn-success" onclick="mostrarform1(true)"><i class="fa fa-plus-circle"></i>Agregar</button></h1>
...
<div class="panel-body" style="height: 400px;" id="formularioregistros1">
  <form action="" name="formulario1" id="formulario1" method="POST">
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="hidden" name="idubicacion1" id="idubicacion1">
      <input class="form-control" type="text" name="nombre1" id="nombre1" maxlength="50" placeholder="Nombre1" required>
    </div>
...
require 'footer.php';
 ?>
 <script src="scripts/ubicacion1.js"></script>
 <?php 
}
