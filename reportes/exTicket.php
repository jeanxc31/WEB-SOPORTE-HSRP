...
$empresa = "HOSPITAL DE LA AMISTAD PERU - COREA SANTA ROSA II";
$documento = "20525832334";
$direccion = "Av. Grau-Chulucanas Nro. Sn A.H. San Martin (Esq Grau con Chulucanas)";
$telefono = "(073) 361075";
$email = "hsantarosa@hsr.gob.pe";
	 ?>
<div class="zona_impresion">
	...
	<table border="0" align="center" width="300px">
		...
		<tr>
			...
			<td>Personal: <?php echo $reg->cliente; ?>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td>
				N° de ticket: <?php echo $reg->serie_comprobante." - ".$reg->num_comprobante; ?>
			</td>
		</tr>
	</table>
	<br>
	...
	<table border="0" align="center" width="300px">
		...
		<tr>
			<td colspan="3">N° de Productos: <?php echo $cantidad; ?> </td>
		</tr>
		<tr>
			<td colspan="3">&nbsp;</td>
		</tr>
		...
		<tr>
			<td colspan="3" align="center">HSRP PIURA</td>
		</tr>
		<tr>
			<td colspan="3" align="center">Piura - Peru</td>
		</tr>
	</table>
	<br>
</div>
